    ...
    <>
      ...
      <main className="min-h-screen">
        <div className="container-max py-16">
          <h1 className="text-4xl font-bold text-foreground mb-4 text-center text-balance">About ServiceHub</h1>
          ...
          <div className="bg-muted rounded-lg p-12 mb-16">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ServiceHub was built to solve a real problem: finding reliable service providers is hard. We created a
          ...
          <div className="bg-primary text-primary-foreground rounded-lg p-12 text-center">
            ...
            <p className="mb-6 opacity-90 text-balance">
              Whether you're looking to offer services or find trusted providers, ServiceHub is the place for you.
            </p>
          </div>
        </div>
      </main>
